# Below are the prompts used to generate the system_info.py module, which gathers compact system information for LLMs to make 
# informed decisions about toolchain installation and usage.
#  
# The code focuses on Windows, macOS, and Linux, including OS details, package managers, CPU info, and toolchain presence (gcc/clang/MSVC, cmake/ninja/make). 
# It uses safe subprocess calls and best-effort parsing while avoiding external dependencies for maximum compatibility.


# --------------------------------------------------------User Prompt-----------------------------------------------------------------------------------------------------:

# Generate a compact system info dict for LLMs to make informed decisions about toolchain installation and usage.
# Focus on Windows, macOS, and Linux. Include OS details, package managers, CPU info, and toolchain presence (gcc/clang/MSVC, cmake/ninja/make).
# Use safe subprocess calls and best-effort parsing. Avoid external dependencies for maximum compatibility.
